## spring security
package com.kim.springsecurity.auth.service;

import com.kim.springsecurity.auth.dto.LoginRequest;
import com.kim.springsecurity.auth.dto.TokenResponse;
import com.kim.springsecurity.auth.entity.RefreshToken;
import com.kim.springsecurity.auth.repository.RefreshTokenRepository;
import com.kim.springsecurity.auth.repository.UserRepository;
import com.kim.springsecurity.command.entity.User;
...
public class AuthService {
    ...
    private final JwtTokenProvier jwtTokenProvider;
    ...
    public TokenResponse refreshToken(String providedRefreshToken) {
        ...
        if(storedToken.getExpiredDate().before(new Date())) {
